...
contract('Insurance', accounts => {
    ...
    beforeEach(async () => {
        ...
        await BitFinance.updateInsuranceRatio(toWei('0.1'));
        await BitFinance.updateMarket(MarketID, toWei('1'), toWei('0.01'), toWei('1.2'), toWei('2'));
    ...
    it('check insurance balance', async () => {
        ...
        assert.equal((await BitFinance.getInsuranceBalance(USDAddr)).toString(), '61643835616438600');
    });
});
