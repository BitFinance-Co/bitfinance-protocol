...
library Order {
    ...
    /**
     * Calculates the Keccak-256 EIP712 hash of the order using the BitFinance Protocol domain.
     *
     * @param order The order data struct.
     * @return Fully qualified EIP712 hash of the order in the BitFinance Protocol domain.
     */
    function getHash(
